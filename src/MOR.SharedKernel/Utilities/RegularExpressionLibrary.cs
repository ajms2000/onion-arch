namespace System
{
    ...
    public struct RegularExpressionLibrary
    {
        ...
        /// <summary>
        /// Matches whether atleast one non-whitespace character is present
        /// </summary>
        public const String HasAnyNonWhitespace = @"^(?!\s*$).+";


        /// <summary>
        /// Matches whether Year Quater character is present
        /// </summary>
        public const String YearQuaterPattern = @"([0-9])([0-9])[-](Q1|Q2|Q3|Q4)";

        /// <summary>
        /// Remove Html tags from Html string
        /// </summary>
        public const String StringPattern_WithoutHtml = @"(<.+?>)";
        ...
        /// Relaxed url pattern.
        /// </summary>
        public const String URLPatternRelaxed = @"(http|https|ftp|ftps|sftp|sftps)://([\w-]+\.)+[\w-]+(:\d{2,5})?(/[\u0020-\u007E]*)?";

        /// <summary>
        /// Relaxed url pattern with spaces.
        /// </summary>
        public const String URLPatternRelaxed_WithoutSpace = @"(http|https|ftp|ftps|sftp|sftps)://([\w-]+\.)+[\w-]+(:\d{2,5})?(/[\u0021-\u007E]*)?";
        ...
        /// <summary>
        /// Time format HH:MM http://stackoverflow.com/questions/7536755/regular-expression-for-matching-hhmm-time-format
        /// </summary>
        public const String TimeFormatPattern = @"^(20|21|22|23|[01]\d|\d)(([:][0-5]\d){1,2})$";

        public const String TimeDurationPattern = @"^(\d{1,3})(([:][0-5]\d){1,2})$";

        public const String DatePattern = @"^(0[1-9]|[1-9]|[12][0-9]|3[01])-([Jj][Aa][Nn]|[Ff][Ee][Bb]|[Mm][Aa][Rr]|[Aa][Pp][Rr]|[Mm][Aa][Yy]|[Jj][Uu][Nn]|[Jj][Uu][Lj]|[Aa][Uu][Gg]|[Ss][Ee][Pp]|[Oo][Cc][Tt]|[Nn][Oo][Vv]|[Dd][Ee][Cc])-(19|20)\d\d$";
        #endregion
